...
var ShowModalEdit = function (ID, InvoiceTruck, ContChi, HangXe, HuongXuat, PIC, Booking,
    ...
    $('#inp-DateTimeDuKien-edit').val((ThoiGianDuKien == "null") ? "" : moment(ThoiGianDuKien).format("YYYY-MM-DD HH:mm"));
    $('#inp-DateTimeCutTime-edit').val((ThoiGianCutTime == "null") ? "" : moment(ThoiGianCutTime).format("YYYY-MM-DD HH:mm"));
    $('#inp-DateTimeNhapCT-edit').val((ThoiGianNhapCT == "null") ? "" : moment(ThoiGianNhapCT).format("YYYY-MM-DD HH:mm"));
            ...
            success: function (result) {
                ...
                if (result) {
                    for (var i = 0; i < result.length; i++) {
                        $("#id-" + result[i]["nameKdtvnWarehouse"] + "-datetime-ContArrived").val((result[i]['timeContArrived'] == null) ? "" : moment(result[i]['timeContArrived']).format("YYYY-MM-DD HH:mm"));
                        $("#id-" + result[i]["nameKdtvnWarehouse"] + "-datetime-TimetakePlace").val((result[i]['timeTakePlace'] == null) ? "" : moment(result[i]['timeTakePlace']).format("YYYY-MM-DD HH:mm"));
                        $("#id-" + result[i]["nameKdtvnWarehouse"] + "-datetime-TimeFinish").val((result[i]['timeFinish'] == null) ? "" : moment(result[i]['timeFinish']).format("YYYY-MM-DD HH:mm"));
